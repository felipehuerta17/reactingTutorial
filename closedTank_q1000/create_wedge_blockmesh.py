...
a[lines[0]] = "    (0 0 0)\n"
a[lines[1]] = "    (" + format(x,".5f") + " " + format(y_plus,".5f") + " " + str(0) + ")\n"
a[lines[2]] = "    (" + format(x,".5f") + " " + format(y_plus,".5f") + " " + format(height, ".5f") + ")\n"
a[lines[3]] = "    (" + str(0) + " " + str(0)      + " " + str(height) + ")\n"
a[lines[4]] = "    (" + format(x,".5f") + " " + format(y_minus,".5f") + " " + str(0) + ")\n"
a[lines[5]] = "    (" + format(x,".5f") + " " + format(y_minus,".5f") + " " + format(height, ".5f") + ")\n"
